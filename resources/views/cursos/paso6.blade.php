                        ...
                        <form action="{{ route('curso.paso6.guardar') }}" method="POST" enctype="multipart/form-data" id="formularioCurso">
                            ...
                            <div class="form-section-card shadow-sm" id="seccion-Presentacion">
                                <div class="eval-title">
                                    ...
                                    <span class="estado-archivo no-subido" id="estadoArchivo-Presentacion">
                                        ✗ Sin archivo
                                    </span>
                                </div>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="archivoPresentacion" class="form-label">
                                        ...
                                        @if ($archivosLocales['presentacion'] === 'actual')
                                            ...
                                            <div id="archivoPresentacionContainer" style="display: none;" class="mt-2">
                                                <input type="file" name="PresentacionLocal" class="form-control" onchange="validarArchivo(this, 'Presentacion')">
                                            </div>
                                        @else
                                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3" onclick="crearCarpeta('Presentacion')">
                            ...
                            <div class="form-section-card shadow-sm" id="seccion-EvaluacionDiagnostica">
                                <div class="eval-title">
                                    ...
                                    <span class="estado-archivo no-subido" id="estadoArchivo-EvaluacionDiagnostica">
                                        ✗ Sin archivo
                                    </span>
                                </div>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="archivoEvaluacionDiagnostica" class="form-label">
                                            Archivo Local (opcional)
                                        ...
                                        @if ($archivosLocales['EvaluacionDiagnosticaLocal'] === 'actual')
                                            ...
                                            <div id="archivoEvaluacionDiagnosticaContainer" style="display: none;" class="mt-2">
                                                <input type="file" name="EvaluacionDiagnosticaLocal" class="form-control" onchange="validarArchivo(this, 'EvaluacionDiagnostica')">
                                            </div>
                                        @else
                                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3" onclick="crearCarpeta('EvaluacionDiagnostica')">
                                                <i class="fas fa-file-upload me-1"></i> Subir archivo local
                            ...
                            <div class="form-section-card shadow-sm" id="seccion-EvaluacionSatisfaccion">
                                <div class="eval-title">
                                    ...
                                    <span class="estado-archivo no-subido" id="estadoArchivo-EvaluacionSatisfaccion">
                                        ✗ Sin archivo
                                    </span>
                                </div>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="archivoEvaluacionSatisfaccion" class="form-label">
                                            Archivo Local (opcional)
                                        ...
                                        @if ($archivosLocales['EvaluacionSatisfaccionLocal'] === 'actual')
                                            ...
                                            <div id="archivoEvaluacionSatisfaccionContainer" style="display: none;" class="mt-2">
                                                <input type="file" name="EvaluacionSatisfaccionLocal" class="form-control" onchange="validarArchivo(this, 'EvaluacionSatisfaccion')">
                                            </div>
                                        @else
                                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3" onclick="crearCarpeta('EvaluacionSatisfaccion')">
                                                <i class="fas fa-file-upload me-1"></i> Subir archivo local
                            ...
                            <div class="form-section-card shadow-sm" id="seccion-EvaluacionFinal">
                                <div class="eval-title">
                                    ...
                                    <span class="estado-archivo no-subido" id="estadoArchivo-EvaluacionFinal">
                                        ✗ Sin archivo
                                    </span>
                                </div>
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="archivoEvaluacionFinal" class="form-label">
                                            Archivo Local (opcional)
                                        ...
                                        @if ($archivosLocales['EvaluacionFinalLocal'] === 'actual')
                                            ...
                                            <div id="archivoEvaluacionFinalContainer" style="display: none;" class="mt-2">
                                                <input type="file" name="EvaluacionFinalLocal" class="form-control" onchange="validarArchivo(this, 'EvaluacionFinal')">
                                            </div>
                                        @else
                                            <button type="button" class="btn btn-outline-dark btn-sm rounded-pill px-3" onclick="crearCarpeta('EvaluacionFinal')">
                                                <i class="fas fa-file-upload me-1"></i> Subir archivo local
