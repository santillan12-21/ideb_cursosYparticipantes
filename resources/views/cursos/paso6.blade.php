...
<style>
    ...
    .form-select.porcentaje-completo {
        border-color: #28a745 !important;
        background-color: #f0fff4 !important;
        border-left: 4px solid #28a745 !important;
    }
    .form-select.porcentaje-vacio {
        border-color: #dc3545 !important;
        background-color: #fff5f5 !important;
        border-left: 4px solid #dc3545 !important;
        animation: pulse-red 2s ease-in-out infinite;
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form action="{{ route('curso.paso6.guardar') }}" method="POST" enctype="multipart/form-data" id="formularioCurso">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="Presentacion" class="form-label">
                                            Porcentaje
                                            <span class="estado-indicador" id="estado-Presentacion"></span>
                                        </label>
                            ...
                            <div class="form-section-card shadow-sm">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="EvaluacionDiagnostica" class="form-label">
                                            Porcentaje
                                            <span class="estado-indicador" id="estado-EvaluacionDiagnostica"></span>
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-percentage"></i></span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DriveEvaluacionDiagnostica" id="DriveEvaluacionDiagnostica" 
                                                class="form-control" 
                                                value="{{ old('DriveEvaluacionDiagnostica', isset($evaluaciones['diagnostica']) ? $evaluaciones['diagnostica']->drive_url : '') }}" 
                                                placeholder="https://drive.google.com/..."
                                                oninput="validarDrive(this)"
                                                onchange="validarDrive(this)">
                                        </div>
                            ...
                            <div class="form-section-card shadow-sm">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="EvaluacionSatisfaccion" class="form-label">
                                            Porcentaje
                                            <span class="estado-indicador" id="estado-EvaluacionSatisfaccion"></span>
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-percentage"></i></span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DriveEvaluacionSatisfaccion" id="DriveEvaluacionSatisfaccion" 
                                                class="form-control" 
                                                value="{{ old('DriveEvaluacionSatisfaccion', isset($evaluaciones['satisfaccion']) ? $evaluaciones['satisfaccion']->drive_url : '') }}" 
                                                placeholder="https://drive.google.com/..."
                                                oninput="validarDrive(this)"
                                                onchange="validarDrive(this)">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="DriveEvaluacionFinal" id="DriveEvaluacionFinal" 
                                                class="form-control" 
                                                value="{{ old('DriveEvaluacionFinal', isset($evaluaciones['final']) ? $evaluaciones['final']->drive_url : '') }}" 
                                                placeholder="https://drive.google.com/..."
                                                oninput="validarDrive(this)"
                                                onchange="validarDrive(this)">
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('#DrivePresentacion, #DriveEvaluacionDiagnostica, #DriveEvaluacionSatisfaccion, #DriveEvaluacionFinal').forEach(campo => {
        validarDrive(campo);
    });
    document.querySelectorAll('#DC3').forEach(campo => {
        validarSelect(campo);
    });
...
function validarSelect(select) {
    ...
    select.classList.remove('porcentaje-completo', 'porcentaje-vacio');
    if (indicador) {
        indicador.classList.remove('estado-verde', 'estado-rojo');
    }
    
    if (valor === '' || valor === null) {
        select.classList.add('porcentaje-vacio');
        if (indicador) indicador.classList.add('estado-rojo');
    } else {
        select.classList.add('porcentaje-completo');
        if (indicador) indicador.classList.add('estado-verde');
    }
