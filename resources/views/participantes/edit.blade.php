    ...
    <form action="{{ route('participantes.update', $participante->id) }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="N" name="N" value="{{ old('N', $participante->N) }}" required>
            </div>
            <div class="col-md-4">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="FechadelCurso" name="FechadelCurso" value="{{ old('FechadelCurso', $participante->FechadelCurso) }}" readonly>
            </div>
        </div>
        <!-- Estado de Pago -->
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <select class="form-select" id="EstadoDePago" name="EstadoDePago" required>
                    ...
                    <option value="Pagado" {{ old('EstadoDePago', $participante->EstadoDePago) == 'Pagado' ? 'selected' : '' }}>Curso Pagado</option>
